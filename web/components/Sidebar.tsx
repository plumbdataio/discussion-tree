...
// Account-global native usage limits (5h / 7d) are no longer held here — the
// Sidebar pushes them into the shared useUsageLimits() store (the numbers are
// account-wide, so every header reads the one value without re-fetching).
