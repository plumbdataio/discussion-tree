...
export const TOOLS = [
  ...
  },
  {
    name: "list_maps",
    description:
      "List the divergent-discussion maps owned by this session (id, title, node_count, url).",
