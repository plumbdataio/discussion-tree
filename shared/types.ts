...
// "completed" / "withdrawn" are set explicitly via set_board_status and are
// NOT touched by node-status changes — they represent user-driven lifecycle
// decisions about the board as a whole.
// "paused" is a hybrid: it is set explicitly (set_board_status shelves the
...
// the board against auto-recompute (paused is un-frozen again by the broker's
// revert-on-new-post, the others stay frozen until re-set).
